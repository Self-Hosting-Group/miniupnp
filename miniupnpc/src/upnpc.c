...
static void usage(FILE * out, const char * argv0) {
	...
	fprintf(out, "  -t TTL : set multicast TTL. Default is 2 (UDA 1.1).\n");
...
#endif
	printf("upnpc: MiniUPnP IGD library test client %s, (c) 2005-2026 Thomas Bernard.\n", MINIUPNPC_VERSION_STRING);
